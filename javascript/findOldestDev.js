/*
You will be given a sequence of objects representing data about developers who have signed
up to attend the next coding meetup that you are organizing.
...
function findSenior(list) {
  let oldest = list.reduce((acc, c) => {return Math.max(acc, c.age)}, 0)
  return list.filter(elem => elem.age === oldest)
}