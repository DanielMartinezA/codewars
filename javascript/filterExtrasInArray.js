...
to show Charlie their entire collection.
...
Task
Given a list and a number, create a new list that contains each number of lst at
...
*/
function filterExtrasInArray(arr,n) {
  let countObj = {}
  return arr.filter(elem => {
    countObj[elem] ? countObj[elem]++ : countObj[elem] = 1
    return countObj[elem] <= n
  })
}
